...
<div class="grid grid-cols-3 gap-6">
	<div class="col-span-1 bg-white rounded-xl shadow p-5">
		...
		<form method="post" action="<?php echo site_url('kelas/simpan'); ?>" class="space-y-3">
			...
			<tbody class="divide-y">
				...
				<?php foreach ($kelas_list as $k): ?>
					<tr class="hover:bg-gray-50">
						<td class="px-4 py-3">
							<form method="post" action="<?php echo site_url('kelas/simpan'); ?>" class="flex items-center gap-2">
